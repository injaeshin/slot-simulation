...
public class GameSimulation
{
    ...
    private readonly ThreadLocal<ThreadStorage.ThreadBuffer> tls;
    private long progress;
    public ref long Progress => ref progress;


    public GameSimulation(IConfiguration conf)
    {
        tls = new ThreadLocal<ThreadStorage.ThreadBuffer>(() => new ThreadStorage.ThreadBuffer());
